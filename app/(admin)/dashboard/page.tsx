...
function OrderPanel({
  ...
  title: string;
  eyebrow: string;
  orders: Awaited<ReturnType<typeof getDashboardSnapshot>>["actionOrders"];
}) {
  return (
      ...
      <section className="surface-card rounded-[32px] px-5 py-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold sm:text-3xl">Live smokehouse command view</h1>
